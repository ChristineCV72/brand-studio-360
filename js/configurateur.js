...
(function () {
  ...
  const SERVICES = {
    ...
    "podcast-studio": {
      label: "Studio de Podcast", icon: I.mic,
      steps: [
        { key: "type", title: "Quel type de projet ?", hint: "Choisissez le format qui correspond le mieux à votre projet.", kind: "cards", options: [
          { id: "episode", label: "Épisode unique", icon: I.mic, base: 600 },
          { id: "serie", label: "Série (par épisode)", icon: I.grid, base: 450 },
          { id: "habillage", label: "Habillage sonore & jingle", icon: I.bulb, base: 500 },
          { id: "cles", label: "Studio clé en main", icon: I.star, base: 1800 },
        ]},
        { key: "objectif", title: "Quel est votre objectif principal ?", hint: "Cela oriente le format et la ligne éditoriale.", kind: "radio", options: [
          { id: "lancer", label: "Lancer un podcast de marque", add: 0 },
          { id: "ajouter", label: "Ajouter un format audio à mon contenu", add: 150 },
          { id: "structurer", label: "Structurer une série existante", add: 200 },
          { id: "immersif", label: "Créer une expérience sonore immersive", add: 350 },
        ]},
        { key: "precisions", title: "Précisez votre projet", hint: "Ces informations affinent l'estimation.", kind: "precisions",
          slider: { name: "Durée de l'épisode", min: 10, max: 90, step: 5, def: 30, unit: "min", perUnit: 15 },
          groups: [
            { name: "Formats de diffusion", multiple: true, options: [
              { id: "spotify", label: "Spotify", add: 0 }, { id: "apple", label: "Apple Podcasts", add: 0 },
              { id: "youtube", label: "YouTube (vidéo)", add: 300 }, { id: "web", label: "Site web", add: 100 },
            ]},
          ]},
        { key: "options", title: "Options supplémentaires", hint: "Affinez votre projet avec des prestations complémentaires.", kind: "toggles", options: [
          { id: "mixage", label: "Montage & mixage avancé", add: 250 },
          { id: "jingle", label: "Habillage sonore / jingle", add: 200 },
          { id: "invite", label: "Invité supplémentaire", add: 150 },
          { id: "diffusion", label: "Diffusion multi-plateformes gérée", add: 300 },
        ]},
      ],
    },

    "event-experience": {
      label: "Event Experience", icon: I.cal,
      steps: [
        { key: "type", title: "Quel type d'événement ?", hint: "Choisissez le format qui correspond le mieux à votre projet.", kind: "cards", options: [
          { id: "petit", label: "Petit événement (- 50 pers.)", icon: I.cal, base: 1200 },
          { id: "moyen", label: "Événement moyen (50-150 pers.)", icon: I.grid, base: 2200 },
          { id: "grand", label: "Grand événement (150+ pers.)", icon: I.star, base: 3800 },
          { id: "recurrent", label: "Événement récurrent / série", icon: I.bulb, base: 2800 },
        ]},
        { key: "objectif", title: "Quel est votre objectif principal ?", hint: "Cela oriente le concept et la scénographie.", kind: "radio", options: [
          { id: "lancer", label: "Lancer un produit", add: 0 },
          { id: "marque", label: "Renforcer ma marque", add: 250 },
          { id: "fideliser", label: "Fidéliser mes clients", add: 200 },
          { id: "recruter", label: "Recruter des talents", add: 200 },
        ]},
        { key: "precisions", title: "Précisez votre projet", hint: "Ces informations affinent l'estimation.", kind: "precisions",
          slider: { name: "Nombre d'invités", min: 20, max: 500, step: 20, def: 100, unit: "pers.", perUnit: 8 },
          groups: [
            { name: "Type d'événement", multiple: false, options: [
              { id: "conference", label: "Conférence", add: 0 }, { id: "soiree", label: "Soirée", add: 300 },
              { id: "lancement", label: "Lancement produit", add: 400 }, { id: "popup", label: "Pop-up store", add: 500 },
            ]},
          ]},
        { key: "options", title: "Options supplémentaires", hint: "Affinez votre projet avec des prestations complémentaires.", kind: "toggles", options: [
          { id: "sceno", label: "Scénographie sur-mesure", add: 600 },
          { id: "captation", label: "Captation photo / vidéo", add: 500 },
          { id: "signal", label: "Signalétique & branding espace", add: 400 },
          { id: "traiteur", label: "Coordination traiteur / logistique", add: 450 },
        ]},
      ],
    },
  };
